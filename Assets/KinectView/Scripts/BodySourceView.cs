...
public class BodySourceView : MonoBehaviour 
{
    ...
    {
        Kinect.JointType jthand = Kinect.JointType.HandRight;
        Kinect.JointType jtknee = Kinect.JointType.KneeRight;
        ...
        if (Body != null)
        {
            ...
            Transform jointObjKnee = Body.transform.FindChild(jtknee.ToString());

            if (jointObjHand.position.y <= jointObjKnee.position.y)
                return true;
        }
        return false;
    }
